export const AuthHeader = () => {
  return (
    <div className="scroll-auto flex flex-col gap-6 w-full justify-center items-center p-4 pb-8 relative">
      <div className="w-20 h-20 ">
        <img className="w-full h-full" src="../public/logo.jpeg" />
      </div>
      <h3 className="font-semibold">Sign up or Login with</h3>
      <div className="w-full gap-2 flex flex-col">
        <div className="cursor-pointer hover:bg-gray-400 duration-300 bg-gray-200 w-full h-10 rounded-lg font-semibold flex gap-10 justify-start items-center px-8">
          <div>
